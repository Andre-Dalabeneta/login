...
<html lang="pt-br">
<!--
    Para acessar esse projeto, habilite o apache no XAMPP
...
<body class="bg-dark">
    ...
    <main class="container mt-4">
        ...
        <section class="row mt-5">
            <div class="col-lg-4 offset-lg-4 bg-light rounded" id="caixaSenha">
                ...
                <form action="#" method="post" id="formSenha" class="p-2">
                    ...
                    <div class="form-group">
                        <input type="email" name="emailGerarSenha" id="emailGerarSenha" class="form-control" placeholder="E-mail de recuperação de senha" required minlength="5">
                    </div>
        ...
        <!-- Início formulário de cadastro de novos usuários -->

        <section class="row mt-5">
            <div class="col-lg-4 offset-lg-4 bg-light rounded" id="caixaRegistro">
                <h2 class="text-container mt-2">Registre-se aqui</h2>
                <form action="#" method="post" class="p-2" id="formRegistro">
                    ...
                    <div class="form-group">
                        <input type="text" name="emailUsuario" id="emailUsuario" class="form-control" placeholder="E-mail" required>
                    </div>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.19.1/jquery.validate.min.js" 7></script>
